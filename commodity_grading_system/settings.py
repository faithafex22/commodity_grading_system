"""
Django settings for commodity_grading_system project.
...
ROOT_URLCONF = 'commodity_grading_system.urls'
...
WSGI_APPLICATION = 'commodity_grading_system.wsgi.application'
